...
import GridBackground from "@/components/gridBackground/page";
			...
			<section className='relative z-10 px-4 md:px-8 lg:px-16 pb-0'>
				<div className='grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center max-w-7xl mx-auto'>
					...
					<motion.div
						...
						className='space-y-6 order-1 lg:order-1 z-30 relative items-center'>
						<motion.h2
						...
						<motion.p
							...
							className='text-base sm:text-lg md:text-xl text-gray-700 dark:text-gray-300 leading-relaxed py-5'>
							{t("about.description")}
						</motion.p>
						<motion.div
							initial={{ opacity: 0, y: 20 }}
							...
							className='relative z-10 start-0 flex justify-start items-center gap-4'>
							<Link
